...
class WorkflowCanvas {
  ...
  render(workflow) {
    ...
    console.log('🎨 Rendering workflow canvas:', workflow.nodes.length, 'nodes');
    ...
    canvasWrapper.style.border = '1px solid #e0e0e0';
    canvasWrapper.style.borderRadius = '8px';
    canvasWrapper.style.background = this.colors.background;
    ...
    defs.innerHTML = `
      <marker id="arrowhead" markerWidth="10" markerHeight="7" 
        ...
        <polygon points="0 0, 10 3.5, 0 7" fill="${this.colors.connectionArrow}" />
      </marker>
    `;
